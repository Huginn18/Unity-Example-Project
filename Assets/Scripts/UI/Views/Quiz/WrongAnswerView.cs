namespace HoodedCrow.UI
{
    ...
    public class WrongAnswerView: AView
    {
        [SerializeField] private Button _exitButton;

        [Space, SerializeField] private AssetReference _mainMenuReference;
        ...
        {
            _loadSceneMessage.Send(new LoadSceneMessageContent(_mainMenuReference));
        }
    }
}
